...
public interface InviteCodeService {
    ...
    /**
     * Lists ALL invite codes across all creators.
     * H-08 FIX: Added to support ADMIN seeing all invite codes (not just their own).
     * ORGANIZER callers use listInviteCodesByCreator() instead.
     *
     * @param pageable Pagination parameters
     * @return Page of all invite codes
     */
